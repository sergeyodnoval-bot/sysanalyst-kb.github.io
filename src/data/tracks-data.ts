...
export const itemLabels: Record<string, Record<string, string>> = {
  article: {
    'how-computer-works': 'Как работает компьютер',
    ...
    'what-is-network': 'Что такое интернет и компьютерная сеть',
    'what-is-app-types': 'Какими бывают приложения: веб, мобайл, десктоп',
    ...
    'what-is-database-basics': 'Как устроены базы данных',
    ...
    'sql-basics': 'Основы SQL (SELECT, JOIN, WHERE)',
    'json-xml': 'JSON и XML',
    ...
    'telecom-path': 'Telecom — роль, специфика, путь',
    'telecom-bss-oss': 'BSS/OSS — архитектура Telecom-систем',
    'telecom-billing': 'Billing и Charging (online/offline)',
    'telecom-crm-order': 'CRM и Order Management в Telecom',
    'telecom-provisioning': 'Provisioning и активация услуг',
    ...
    'gamedev-gdd': 'GDD и документация в GameDev',
    ...
    'gamedev-sdk': 'SDK-интеграции в играх',
    'gamedev-publishing': 'Публикация и платформы',
  ...
  stages: [
    ...
    },
    {
      ...
      items: [
        ...
        {type: 'article', id: 'caching', folder: 'architecture'},
        {type: 'article', id: 'resilience-patterns', folder: 'architecture'},
    ...
    {
      title: '8. Продвинутая архитектура, интеграции и Observability',
      description: 'DDD, Hexagonal, Saga, Strangler Fig, EIP, API Gateway, Event Storming, Observability и специализации.',
      items: [
        ...
        {type: 'article', id: 'logging', folder: 'architecture'},
        {type: 'article', id: 'monitoring', folder: 'architecture'},
        {type: 'article', id: 'tracing', folder: 'architecture'},
        {type: 'tech', id: 'prometheus'},
...
const solutionArchitectTrack: TrackDef = {
  ...
  stages: [
    ...
    {
      title: '2. Domain-Driven Design, событийное моделирование и кросс-концерны',
      description: 'DDD, Hexagonal Architecture, Saga, Event Storming, авторизация и кросс-концерны для сложных предметных областей.',
      items: [
        {type: 'article', id: 'ddd-intro', folder: 'architecture'},
        {type: 'article', id: 'hexagonal-architecture', folder: 'architecture'},
        {type: 'article', id: 'saga-pattern', folder: 'architecture'},
        {type: 'article', id: 'authorization', folder: 'architecture'},
        {type: 'article', id: 'event-storming', folder: 'integration'},
        {type: 'article', id: 'event-storming-advanced', folder: 'integration'},
      ],
    },
    ...
    {
      title: '4. Асинхронные и событийные системы, Observability',
      description: 'EDA детально, брокеры сообщений, асинхронные очереди, Observability (логи, метрики, трейсинг) и Kafka.',
      items: [
        {type: 'article', id: 'eda-detailed', folder: 'architecture'},
        {type: 'article', id: 'event-driven-architecture', folder: 'integration'},
        {type: 'article', id: 'async-message-queue', folder: 'integration'},
...
const fintechTrack: TrackDef = {
  ...
  stages: [
    ...
    {
      title: '1. Регуляторика, протоколы и Open Banking',
      description: 'Разберитесь с регуляторами, платёжными протоколами и Open Banking API.',
      items: [
    ...
    {
      title: '2. Ledger, сверка и учёт',
      description: 'Поймите Double-entry ledger, проектируйте системы сверки транзакций.',
      items: [
    ...
    {
      title: '3. Фрод-мониторинг и кредитный конвейер',
  ...
  stages: [
    {
      ...
      items: [
        ...
        {type: 'article', id: 'gamedev-gdd', folder: 'specialization'},
    ...
    {
      title: '3. LiveOps, SDK и публикация',
      description: 'Управление живым продуктом, SDK-интеграции, метрики, публикация.',
      items: [
        {type: 'article', id: 'gamedev-liveops', folder: 'specialization'},
        {type: 'article', id: 'gamedev-analytics', folder: 'specialization'},
        {type: 'article', id: 'gamedev-sdk', folder: 'specialization'},
        {type: 'article', id: 'gamedev-publishing', folder: 'specialization'},
        {type: 'tech', id: 'appsflyer'},
        {type: 'tech', id: 'firebase'},
