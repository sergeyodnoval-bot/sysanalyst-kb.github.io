const LABELS: Record<string, string> = {
  ...
  'basics/security-fundamentals': 'Основы безопасности для системного аналитика',
  ...
  'modeling/activity-diagram': 'Activity diagram (UML Activities)',
  ...
  'soft/conflict-resolution': 'Конфликты и стресс в работе аналитика',
  'soft/business-case-writing': 'Бизнес-кейс и обоснование решений',
